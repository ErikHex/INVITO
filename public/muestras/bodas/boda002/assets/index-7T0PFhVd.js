...
const l = {
  couple: {
    ...
    partnerB: "Rodrigo",
    monogram: "V & R",
    hashtag: "#ValeYRodrigoSeCasan",
  },
  hero: {
    eyebrow: "Con la bendición de Dios y de nuestras familias",
    title: "Nos casamos",
    quote:
      "“Este es el día en que actuó el Señor; nos gozaremos y alegraremos en él.”",
    quoteSource: "Salmos 118:24",
    photo:
      "https://res.cloudinary.com/tnxqwvsy/image/upload/v1788215193/Pareja_Foto_Jonathan_Borba_1.webp",
    photoAlt: "Valentina y Rodrigo",
  },
  event: {
    dateISO: "2026-11-14T17:00:00-06:00",
    dateDisplay: "14 de noviembre de 2026",
    ceremony: {
      label: "Ceremonia religiosa",
      time: "5:00 p.m.",
      venue: "Parroquia de San Jerónimo",
      address: "Av. San Jerónimo 263, La Otra Banda, CDMX",
      mapUrl: "https://maps.google.com/?q=Parroquia+de+San+Jer%C3%B3nimo+CDMX",
    },
    reception: {
      label: "Recepción",
      time: "7:00 p.m.",
      venue: "Hacienda de los Morales",
      address: "Vázquez de Mella 525, Del Bosque, CDMX",
      mapUrl: "https://maps.google.com/?q=Hacienda+de+los+Morales",
    },
    dressCode: "Formal / Etiqueta rigurosa",
    notes: "No niños, por favor. Agradecemos tu comprensión.",
  },
  story: [
    {
      year: "2019",
      title: "Un café que se alargó tres horas",
      text: "Nos presentó un amigo en común. Lo que iba a ser un café rápido terminó siendo una tarde entera de conversación.",
      photo:
        "https://res.cloudinary.com/tnxqwvsy/image/upload/v1788215194/Pareja_Foto_Gratis_1.webp",
    },
    {
      year: "2021",
      title: "El primer viaje juntos",
      text: "Oaxaca nos enseñó que viajábamos igual de bien de lo que conversábamos: sin prisa y siempre buscando el siguiente mezcal.",
      photo:
        "https://res.cloudinary.com/tnxqwvsy/image/upload/v1788215193/Pareja_Foto_Gratis.webp",
    },
    {
      year: "2024",
      title: "La pregunta",
      text: "Una tarde de domingo, sin anuncios ni cámaras escondidas, Rodrigo preguntó y Valentina dijo que sí antes de que terminara la frase.",
      photo:
        "https://res.cloudinary.com/tnxqwvsy/image/upload/v1788215134/Pareja_Foto_Jonathan_Borba.webp",
    },
  ],
  gallery: {
    title: "Momentos",
    photos: [
      {
        src: "https://res.cloudinary.com/tnxqwvsy/image/upload/v1788215193/Pareja_Foto_Jonathan_Borba_3.webp",
        alt: "Valentina y Rodrigo, retrato",
        span: "tall",
      },
      {
        src: "https://res.cloudinary.com/tnxqwvsy/image/upload/v1788215193/Pareja_Foto_Jonathan_Borba_4.webp",
        alt: "Paseo por la playa",
        span: "wide",
      },
      {
        src: "https://res.cloudinary.com/tnxqwvsy/image/upload/v1788215193/Pareja_Foto_Jonathan_Borba_3.webp",
        alt: "Cena de aniversario",
        span: "normal",
      },
      {
        src: "https://res.cloudinary.com/tnxqwvsy/image/upload/v1788215194/Pareja_Foto_Gratis_2.webp",
        alt: "Viaje a Oaxaca",
        span: "normal",
      },
      {
      ...
      {
        src: "https://res.cloudinary.com/tnxqwvsy/image/upload/v1788215134/Pareja_Foto_Jonathan_Borba.webp",
        alt: "Familia",
        span: "tall",
      },
    ],
  ...
  music: {
    src: "./audio/Lunar Eclipse Winter Lake Music.mp3",
    title: "Lunar Eclipse Winter Lake Music",
  },
  rsvp: {
    endpoint: "",
    fallbackEmail: "boda.valeyrodrigo@example.com",
    deadlineDisplay: "15 de octubre de 2026",
    maxGuestsPerInvite: 2,
    askDietaryRestrictions: !0,
    askSongRequest: !0,
  },
  registry: {
    title: "Mesa de regalos",
    text: "Tu presencia es el regalo más importante. Si deseas obsequiarnos algo más, contamos con mesa de regalos en Liverpool y sobre para lluvia de sobres.",
    links: [
      {
...
function v(t) {
  ...
  ((e.id = "envelope"),
    (e.className =
      "fixed inset-0 z-50 flex items-center justify-center bg-ink text-paper transition-opacity duration-[900ms] ease-out"),
    (e.innerHTML = `
  ...
  `),
    ...
    e.querySelector("#open-envelope-btn").addEventListener("click", () => {
      (e.classList.add("pointer-events-none", "opacity-0"),
        document.body.classList.remove("overflow-hidden"),
        t(),
        setTimeout(() => e.remove(), 950));
    }));
}
function b(t, e = 120, a = 34, s = 420) {
  const n = Math.ceil(t / (s / 2));
  let r = `M ${e / 2} 0`,
    o = 0,
    i = 1;
  for (let d = 0; d < n; d++) {
    const c = Math.min(o + s / 2, t),
      u = o + (c - o) / 2,
      p = e / 2 + a * i;
    ((r += ` C ${p} ${u}, ${p} ${u}, ${e / 2} ${c}`), (o = c), (i *= -1));
  }
  return { d: r, segments: n };
}
function y(t, e, a) {
  const s = t + a * 22,
    n = e - 10;
  return `<path d="M ${t} ${e} Q ${s} ${n} ${t + a * 4} ${e - 26}" stroke-linecap="round" />`;
}
function h(t) {
  const e = document.createElement("div");
  ((e.id = "botanical-spine"),
  ...
  return (
    ...
    window.addEventListener("resize", () => {
      (clearTimeout(window.__spineResizeT),
        (window.__spineResizeT = setTimeout(a, 200)));
    }),
    a
  );
}
function w() {
  const { hero: t, couple: e, event: a } = l;
  return `
    ...
    <div class="mx-auto max-w-content text-center" data-reveal>
      ...
      <div id="countdown" class="mt-8 flex flex-wrap items-start justify-center gap-6 md:gap-14">
        ...
        `,
          ...
          .join(
            '<span class="pt-2 font-display text-3xl text-gold/60 md:text-4xl">·</span>',
          )}
      </div>
...
function q() {
  const t = new Date(l.event.dateISO).getTime(),
  ...
  function a() {
    const s = Math.max(t - Date.now(), 0),
      ...
      i = Math.floor((s % 6e4) / 1e3);
    Object.entries({ days: n, hours: r, minutes: o, seconds: i }).forEach(
      ([c, u]) => {
        const p = e.querySelector(`[data-unit="${c}"]`);
        p && (p.textContent = String(u).padStart(2, "0"));
      },
    );
  }
  (a(), setInterval(a, 1e3));
}
function x({ label: t, time: e, venue: a, address: s, mapUrl: n }) {
  return `
...
const _ = {
  ...
  g = [0.08, 0.18, 0.1, 0.22, 0.14, 0.09];
function C() {
  const { gallery: t } = l,
    e = t.photos
      .map(
...
function j() {
  const { rsvp: t } = l,
    e = Array.from({ length: t.maxGuestsPerInvite }, (a, s) => s + 1)
      .map(
        (a) =>
          `<option value="${a}">+${a} ${a === 1 ? "acompañante" : "acompañantes"}</option>`,
      )
      .join("");
  return `
...
function L() {
  const t = document.getElementById("rsvp-form");
  if (!t) return;
  const e = document.getElementById("rsvp-status"),
    a = t.querySelector('button[type="submit"]'),
    s = t.querySelector("[data-btn-label]"),
    { rsvp: n } = l;
  t.addEventListener("submit", async (r) => {
    r.preventDefault();
    const o = Object.fromEntries(new FormData(t).entries());
    if (!t.checkValidity()) {
      ((e.textContent = "Por favor completa los campos requeridos."),
        (e.className = "text-center text-sm text-accent"),
        t.reportValidity());
      return;
    }
    ((a.disabled = !0), (s.textContent = "Enviando…"));
    try {
      const i = JSON.parse(localStorage.getItem("rsvp-backup") || "[]");
      (i.push({ ...o, submittedAt: new Date().toISOString() }),
        localStorage.setItem("rsvp-backup", JSON.stringify(i)));
    } catch {}
    try {
      if (!n.endpoint) {
        const i = encodeURIComponent(`Confirmación de asistencia — ${o.name}`),
          d = encodeURIComponent(`Nombre: ${o.name}
Correo: ${o.email}
Asistencia: ${o.attending}
Acompañantes: ${o.guests}
${
  o.diet
    ? `Restricciones: ${o.diet}
`
    : ""
}${
            o.song
...
`
        ...
        window.location.href = `mailto:${n.fallbackEmail}?subject=${i}&body=${d}`;
      }
      ((e.textContent =
        o.attending === "si"
          ? `¡Gracias, ${o.name}! Nos dará mucho gusto celebrar contigo.`
          : `Gracias por avisarnos, ${o.name}. Te extrañaremos.`),
        (e.className = "text-center text-sm text-ink"),
        t.reset(),
        (s.textContent = "Confirmación enviada ✓"));
    } catch {
      ((e.textContent = `No pudimos enviar tu confirmación automáticamente. Escríbenos a ${n.fallbackEmail}.`),
        (e.className = "text-center text-sm text-accent"),
        (s.textContent = "Reintentar"),
        (a.disabled = !1));
    }
  });
}
...
function P() {
  const t = document.getElementById("bg-audio"),
    e = document.getElementById("music-toggle"),
    a = document.getElementById("music-icon"),
    s = document.getElementById("music-hint");
  if (!t || !e) return;
  t.volume = 0.55;
  let n = !1;
  function r(o) {
    ((n = o),
      ...
      e.setAttribute(
        "aria-label",
        o ? "Pausar música de fondo" : "Reproducir música de fondo",
      ),
      a.classList.toggle("is-spinning", o),
      s && (s.style.opacity = o ? "0" : "1"));
  }
  (e.addEventListener("click", async () => {
    try {
      n ? (t.pause(), r(!1)) : (await t.play(), r(!0));
    } catch {}
  }),
    document.addEventListener("invitation:opened", async () => {
      try {
        (await t.play(), r(!0));
      } catch {
        r(!1);
...
function A() {
  const { couple: t, registry: e, event: a } = l;
  return `
...
function D() {
  const t = Array.from(document.querySelectorAll("[data-parallax]"));
  if (!t.length || m) return;
  let e = !1;
  function a() {
    const n = window.innerHeight;
    (t.forEach((r) => {
      const o = parseFloat(r.dataset.parallax) || 0.3,
        i = r.getBoundingClientRect(),
        c = (i.top + i.height / 2 - n / 2) * -o * 0.15;
      r.style.transform = `translate3d(0, ${c.toFixed(1)}px, 0)`;
    }),
      (e = !1));
  }
  function s() {
...
function I() {
  const t = Array.from(document.querySelectorAll("[data-reveal]"));
  if (!t.length) return;
  if (m) {
    t.forEach((a) => a.classList.add("is-visible"));
    return;
  }
  const e = new IntersectionObserver(
    (a) => {
      a.forEach((s) => {
        s.isIntersecting &&
          (s.target.classList.add("is-visible"), e.unobserve(s.target));
      });
    },
    { threshold: 0.15, rootMargin: "0px 0px -8% 0px" },
  );
  t.forEach((a) => e.observe(a));
}
function f(t = "#botanical-spine-path") {
  const e = document.querySelector(t);
  if (!e) return;
  const a = e.getTotalLength();
  if (
    ((e.style.strokeDasharray = `${a}`),
    (e.style.strokeDashoffset = m ? "0" : `${a}`),
    m)
  )
    return;
  let s = !1;
  function n() {
    const o = window.scrollY,
      ...
      d = Math.min(Math.max(o / i, 0), 1);
    ((e.style.strokeDashoffset = `${a * (1 - d)}`), (s = !1));
  }
  function r() {
    s || (requestAnimationFrame(n), (s = !0));
  }
...
function B() {
  const t = document.documentElement,
    { colors: e, fonts: a } = l.theme;
  (Object.entries(e).forEach(([s, n]) =>
    t.style.setProperty(`--color-${s}`, R(n)),
  ),
    Object.entries(a).forEach(([s, n]) =>
      t.style.setProperty(`--font-${s}`, n),
    ));
}
function F() {
  ...
  `;
  const e = t.querySelector("main"),
    a = h(e);
  return (document.body.insertAdjacentHTML("beforeend", M()), { drawSpine: a });
}
function O(t) {
  (q(),
    L(),
...
function T() {
  (B(), document.body.classList.add("overflow-hidden"));
  const { drawSpine: t } = F();
  (O(t),
    v(() => {
